...
**作成日:** 2026年8月21日  
**文書状態:** ACCEPTED<br>
**実行状態:** IN PROGRESS（Milestone A・B COMPLETE / Milestone CのC1・C2 COMPLETE・C3 Gate 1〜3 ACCEPTED・Gate 4 NEXT）<br>
...
| 項目 | 内容 |
|---|---|
| Phase / status | Phase 1a / Milestone A・B COMPLETE、Milestone CのC1・C2 COMPLETE／C3 Gate 1〜3 ACCEPTED・Gate 4 NEXT |
...
- Phase 1aの次回WPはC3 Public API Compatibilityとする。C3〜C5および後続Phaseの成果物は未実装である。
...
| C3 | Public API / japicmp | API inventory、baseline artifact、除外・例外方針 | Gate 1〜3 ACCEPTED（2026年8月27日）／Gate 4 NEXT。local positive / negative fixture PASS。Public API破壊で失敗、`internal`変更は規約どおり判定 |
