...
**作成日:** 2026年8月21日  
**文書状態:** ACCEPTED<br>
**実行状態:** IN PROGRESS（Milestone A・B COMPLETE / Milestone CのC1〜C3 COMPLETE・C4 Gate 1 ACCEPTED・Gate 2 NEXT）<br>
...
| 項目 | 内容 |
|---|---|
| Phase / status | Phase 1a / Milestone A・B COMPLETE、Milestone CのC1〜C3 COMPLETE／C4 Gate 1 ACCEPTED・Gate 2 NEXT |
...
- Phase 1aの次回WPはC4 Java runtime matrixとし、Gate 1計画を承認済みである。C4実装、C5および
  後続Phaseの成果物は未実装である。
...
| C4 | Java runtime matrix | G6の起動fixture、Java 21 build artifact | Gate 1 ACCEPTED（2026年8月27日）／Gate 2 NEXT。Tooling-owned非配布fixture、major 65、同一SHA-256、Java 21 / 25起動、独立CIを計画 |
