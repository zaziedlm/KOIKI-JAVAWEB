...
| P4-AR4 Reference Application baseline | BLOCKED / REFERENCE TEST DATE BOUNDARY REMEDIATION REQUIRED | `validation/pre-phase4-p4-ar4-reference-application-baseline.md` |
