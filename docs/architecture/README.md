...
Milestone CのC1〜C4まで完了し、C5 Phase 1a CloseoutはGate 1〜2 ACCEPTED / Gate 3 READY FOR OWNER REVIEWです。
...
| C5 | Gate 1〜2 ACCEPTED / Gate 3 READY FOR OWNER REVIEW | `validation/phase1a-closeout.md` |
