...
Milestone CのC1〜C4まで完了し、C5 Phase 1a CloseoutはGate 1 ACCEPTED / Gate 2 READY FOR OWNER REVIEWです。
...
| C5 | Gate 1 ACCEPTED / Gate 2 READY FOR OWNER REVIEW | `validation/phase1a-closeout.md` |
