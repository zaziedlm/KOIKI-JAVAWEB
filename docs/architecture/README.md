...
Milestone CのC1〜C3まで完了し、C4 Java runtime matrixはGate 1〜2 ACCEPTED / Gate 3 NEXTです。
...
| C4 | Gate 1〜2 ACCEPTED / Gate 3 NEXT | `validation/phase1a-java-runtime-matrix.md` |
