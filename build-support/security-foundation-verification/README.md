...
P2-A2までのdependency baselineとT0 / T1 / T2 security boundaryは次で検証する。

```powershell
pwsh -NoProfile -File build-support/security-foundation-verification/verify-p2-a2-local-session.ps1
```
