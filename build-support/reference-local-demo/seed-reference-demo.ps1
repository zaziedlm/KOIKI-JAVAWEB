...
VALUES
    ('b2000000-0000-4000-8000-000000000100', 'P3_DEMO_REVIEWER', 0,
     CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO koiki_permission
    (permission_id, permission_code, version, created_at, updated_at)
VALUES
    ('b2000000-0000-4000-8000-000000000101', 'EXPENSE:APPLY', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('b2000000-0000-4000-8000-000000000102', 'EXPENSE:APPROVE', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('b2000000-0000-4000-8000-000000000103', 'EXPENSE:SETTLE', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('b2000000-0000-4000-8000-000000000104', 'IDENTITY:ADMIN', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('b2000000-0000-4000-8000-000000000105', 'MASTER:ADMIN', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
SELECT 'b2000000-0000-4000-8000-000000000100', permission_id
...
VALUES
    ('b2000000-0000-4000-8000-000000000001',
     'b3000000-0000-4000-8000-000000000001', 0,
     CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
    ('b2000000-0000-4000-8000-000000000001',
     'b3000000-0000-4000-8000-000000000001', CURRENT_TIMESTAMP);
