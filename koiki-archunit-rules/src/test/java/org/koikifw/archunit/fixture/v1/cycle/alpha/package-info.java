@KoikiModule(name = "alpha", tier = ModuleTier.SIMPLE,
        persistence = PersistenceTechnology.JDBC, persistenceModel = PersistenceModel.SEPARATED)
package org.koikifw.archunit.fixture.v1.cycle.alpha;
